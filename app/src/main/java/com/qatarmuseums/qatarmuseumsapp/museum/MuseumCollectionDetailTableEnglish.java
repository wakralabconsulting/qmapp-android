...
@Entity(tableName = "museumcollectiondetailtableEnglish")
public class MuseumCollectionDetailTableEnglish {
    @ColumnInfo()
...
//    }
    ...
    public MuseumCollectionDetailTableEnglish(String category_id, @NonNull String detail_title, String detail_image1, String detail_description1) {
        this.category_id = category_id;
        this.detail_title = detail_title;
        this.detail_image1 = detail_image1;
        this.detail_description1 = detail_description1;
