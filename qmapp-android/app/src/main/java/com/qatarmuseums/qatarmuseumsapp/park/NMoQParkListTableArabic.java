...
@Entity(tableName = "nMoQParkListTableArabic")
public class NMoQParkListTableArabic {
    ...
    public NMoQParkListTableArabic(@NonNull String parkNid, String parkTitle, String parkSortId,
                                   String parkImages) {
