...
public class BarCodeCaptureActivity extends AppCompatActivity implements Handler.Callback, BarcodeReader.BarcodeReaderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        keypad = findViewById(R.id.textKeyboard);
        ...
        numberPad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent numberPadIntent = new Intent(BarCodeCaptureActivity.this, ObjectSearchActivity.class);
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        boolean c = false;//gestureDetector.onTouchEvent(e);
...
//                Log.w(TAG, getString(R.string.low_storage_error));
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (grantResults.length != 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            if (!showRationale) {
                showNavigationDialog(getString(R.string.permission_required), getString(R.string.camera_runtime_permission));
            }
        }
...
//                .show();
    ...
    public boolean handleMessage(Message msg) {
        if (msg.what == BarcodeGraphicTracker.LOGIN_DATA_MESSAGE) {
            HashMap<String, String> loginDict = (HashMap<String, String>) msg.obj;
            Intent returnIntent = new Intent();
            returnIntent.putExtra("result", loginDict);
            setResult(Activity.RESULT_OK, returnIntent);
//            ActivityHelper.activityTransition = true;
            finish();
        } else {
            return false;
        }
