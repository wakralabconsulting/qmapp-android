...
@Entity(tableName = "facilitydetailtableenglish")
public class FacilityDetailTableEnglish {
    ...
    public FacilityDetailTableEnglish(@NonNull String facilityNid, String sortId, String facilityTitle,
